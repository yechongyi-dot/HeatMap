...
export function RankView({ plat, win, onPlat, onWin, dataVersion, channelFilter, onClearChannelFilter }) {
  ...
  const resetKey = `${plat}|${win}|${search}|${sort}|${dur}|${noShorts}|${noLive}|${channelFilter || ''}`;
